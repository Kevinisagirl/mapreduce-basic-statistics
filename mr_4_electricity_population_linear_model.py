...
# This will find the alpha and beta using population as a predictor
...
class MRElectricityAreaLinearRegression(MRJob):
    ...
    def mapper(self, _, line):
        ...
        if line[0] != 'state':  # to ignore header
            ...
            yield "", (x_population, y_electricity)
    ...
    def reducer(self, key, values):
        ...
        yield "alpha using population as a predictor", slope
        yield "beta using population as a predictor", intercept
